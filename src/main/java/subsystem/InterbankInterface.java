...
public interface InterbankInterface {
	 ...
	 */
	public abstract PaymentTransaction payOrder(CardStrategy card, int amount, String contents) 
	 ...
	 *                               something goes wrong
	 */
	public abstract PaymentTransaction refund(CardStrategy card, int amount, String contents)
			throws PaymentException, UnrecognizedException;
